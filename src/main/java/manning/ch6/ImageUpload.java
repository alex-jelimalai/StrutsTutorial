...
/*
 * This action uploads an image file using the default fileUpload interceptor. The interceptor is in the default stack and the only thing we have to do here in
 * the action is implement JavaBean's properties to receive the File and meta-data from the interceptor.
 */
