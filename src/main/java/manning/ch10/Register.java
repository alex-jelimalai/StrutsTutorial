...
import manning.ch10.utils.Portfolio;
...
public class Register extends ActionSupport implements SessionAware {
    ...
    /*
     * Validateable Implementation The validate method validates, invoked by the validation interceptor in the default stack, will validate the data already set
